...
export class CadastroSituacaoInternaItemPedidoServicoApp extends ServicoAplicacao {
    ...
    async executar(model: {
        ...
        if (await this._situacaoInternaItemRepositorio.retornarEntidade(opcoesBuscaPorId))
        ...
        if (await this._situacaoInternaItemRepositorio.retornarEntidade(opcoesBuscaPorDescricao))
        ...
        await this._situacaoInternaItemRepositorio.salvarEntidade(situacaoInternaItemPedido);
