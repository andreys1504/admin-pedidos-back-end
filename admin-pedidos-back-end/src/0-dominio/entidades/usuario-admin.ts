...
@Entity(TabelasBancoDados.USUARIO_ADMIN)
export class UsuarioAdmin extends Entidade {
    ...
    @JoinTable({
        name: TabelasBancoDados.USUARIO_PERMISSOES,
        joinColumn: { name: TabelasBancoDados.USUARIO_ADMIN + "Id", referencedColumnName: "id" },
        inverseJoinColumn: { name: TabelasBancoDados.PERMISSAO_ACESSO + "Id", referencedColumnName: "id" }
    })
