...
import { IdsTransportadoraFreteConstante } from "../constantes/transportadora-frete/ids-transportadora-frete.constante";
import { Pedido } from "./pedido";

@Entity(TabelasBancoDados.PEDIDO_DADOS_ENTREGA)
export class PedidoDadosEntrega extends Entidade {
    ...
    @Column({ name: TabelasBancoDados.TRANSPORTADORA_FRETE + "Id", type: 'integer' })
    ...
    @JoinColumn({ name: TabelasBancoDados.TRANSPORTADORA_FRETE + "Id" })
