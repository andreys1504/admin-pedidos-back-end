...
routes.post('/autenticar',
    catchErrorsRoute(async (routeContext: RouteContext) => await new AutenticacaoController().handle(routeContext)));

routes.get('/validar-token',
    authorize(),
    catchErrorsRoute((routeContext: RouteContext) => new ValidacaoTokenController().handle(routeContext)));

routes.post('/alterar-senha',
    authorize(),
    catchErrorsRoute(async (routeContext: RouteContext) => await new AlteracaoSenhaController().handle(routeContext)));
