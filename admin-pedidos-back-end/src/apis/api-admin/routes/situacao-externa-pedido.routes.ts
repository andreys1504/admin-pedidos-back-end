...
routes.get('/',
    authorize(),
    catchErrorsRoute(async (routeContext: RouteContext) => await new SituacoesExternasPedidoController().handle(routeContext)));

routes.post('/',
    authorize(),
    catchErrorsRoute(async (routeContext: RouteContext) => await new CadastroSituacaoExternaPedidoController().handle(routeContext)));

routes.get('/ativos',
    authorize(),
    catchErrorsRoute(async (routeContext: RouteContext) => await new SituacoesExternasPedidoAtivasController().handle(routeContext)));
