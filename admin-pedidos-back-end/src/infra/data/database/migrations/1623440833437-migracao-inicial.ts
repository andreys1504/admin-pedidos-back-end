...
export class migracaoInicial1623440833437 implements MigrationInterface {
    name = 'migracaoInicial1623440833437'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pedido" ("id" SERIAL NOT NULL, "id2" character varying NOT NULL, "dataEmissaoPedido" date NOT NULL, "usuarioRegistroPedidoId" integer NOT NULL, "situacaoExternaPedidoId" integer NOT NULL, "tipoPagamentoPedidoId" integer NOT NULL, "clienteId" integer NOT NULL, "tipoPedidoId" integer NOT NULL, "dataPrevisaoEntrega" date, "tamanhoItensPedido" text NOT NULL, "dataFinalizacaoPedido" date, "usuarioResponsavelPedidoId" integer NOT NULL, "receberPedidoResidencia" boolean NOT NULL, "observacaoCliente" text NOT NULL, "pedidoRealizadoLojaVirtual" boolean NOT NULL, "idPedidoEmSistemaPagamentoExterno" character varying NOT NULL, "dataCriacao" TIMESTAMP NOT NULL, "dataAtualizacao" TIMESTAMP NOT NULL, CONSTRAINT "PK_af8d8b3d07fae559c37f56b3f43" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "cliente" ("id" SERIAL NOT NULL, "nome" character varying(45) NOT NULL, "nomeGuerra" character varying(45) NOT NULL, "tipoClienteId" integer NOT NULL, "cpfCnpj" character varying(14) NOT NULL, "logradouro" character varying(150) NOT NULL, "cep" character varying(8) NOT NULL, "nomeCidade" character varying(150) NOT NULL, "siglaUf" character varying(2) NOT NULL, "telefone" character varying(16) NOT NULL, "email" character varying(100) NOT NULL, "tipoSanguineo" character varying(10) NOT NULL, "medidasCliente" text NOT NULL, "dataCriacao" TIMESTAMP NOT NULL, "dataAtualizacao" TIMESTAMP NOT NULL, CONSTRAINT "PK_18990e8df6cf7fe71b9dc0f5f39" PRIMARY KEY ("id"))`);
